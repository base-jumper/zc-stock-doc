...
def main() -> int:
    ...
    parser.add_argument("n", nargs="?", type=int, help="Limit to the top N (default: all).")
    ...
    try:
        ...
        if args.wa == 0.0:
            ...
            announcement_warnings: list[str] = []
        else:
            announcement_counts, announcement_warnings = load_pending_announcements(
                args.stock_dir,
